...
public class HelpDesk extends JFrame {
    ...
    private void initializeGUI() {
        ...
        storageColorCodeHeadline = new JLabel("Farbbedeutung der Lagerplätze");
        addElementToPanel(storageColorCodeHeadline, null, panel);

        fullStorage = new JLabel("Produkt");
        JLabel fullStorageDescription = new JLabel("LagerPlaty ist bereits voll");
        addElementToPanel(fullStorage, fullStorageDescription, panel);

        scrollPane1.add(panel);
    }

    private void addElementToPanel(JComponent label, JComponent description, JPanel panel) {
